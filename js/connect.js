document.addEventListener('DOMContentLoaded', () => {
        ...
        const result = document.querySelector('#result0')
        ...
        for (var i = 0, len = squares.length; i < len; i++)
            ...
            squares[i].onclick = function() {
                ...
                if (squares[index + 7].classList.contains('taken')) {
                    ...
                    //if squere below is your current squere is not taken, you can't go here
        ...
        function checkBoard() {
            ...
            for (let y = 0; y < winningArrays.length; y++) {
                ...
                const square4 = squares[winningArrays[y][3]]
                    //now check those arrays to see if they all have the class player-one
                ...
                //now check to see if they all have the class name of player-two
                    ...
                    resul.innerHTML = 'Plater two wins!!'
                }
            }
        }

        //add an evenListener to each square that will trigger the checkBoard function on click
